...
func (_USDT *USDTTransactor) Deposit(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _USDT.contract.Transact(opts, "deposit")
}

// Deposit is a paid mutator transaction binding the contract method 0xd0e30db0.
//
// Solidity: function deposit() payable returns()
func (_USDT *USDTSession) Deposit() (*types.Transaction, error) {
	return _USDT.Contract.Deposit(&_USDT.TransactOpts)
}

// Deposit is a paid mutator transaction binding the contract method 0xd0e30db0.
//
// Solidity: function deposit() payable returns()
func (_USDT *USDTTransactorSession) Deposit() (*types.Transaction, error) {
	return _USDT.Contract.Deposit(&_USDT.TransactOpts)
}
...
func (_USDT *USDTTransactor) Mint(opts *bind.TransactOpts, account common.Address, amount *big.Int) (*types.Transaction, error) {
	return _USDT.contract.Transact(opts, "mint", account, amount)
}

// Mint is a paid mutator transaction binding the contract method 0x40c10f19.
//
// Solidity: function mint(address account, uint256 amount) returns()
func (_USDT *USDTSession) Mint(account common.Address, amount *big.Int) (*types.Transaction, error) {
	return _USDT.Contract.Mint(&_USDT.TransactOpts, account, amount)
}

// Mint is a paid mutator transaction binding the contract method 0x40c10f19.
//
// Solidity: function mint(address account, uint256 amount) returns()
func (_USDT *USDTTransactorSession) Mint(account common.Address, amount *big.Int) (*types.Transaction, error) {
	return _USDT.Contract.Mint(&_USDT.TransactOpts, account, amount)
}
...
func (_USDT *USDTTransactor) Withdraw(opts *bind.TransactOpts, amount *big.Int) (*types.Transaction, error) {
	return _USDT.contract.Transact(opts, "withdraw", amount)
}

// Withdraw is a paid mutator transaction binding the contract method 0x2e1a7d4d.
//
// Solidity: function withdraw(uint256 amount) returns()
func (_USDT *USDTSession) Withdraw(amount *big.Int) (*types.Transaction, error) {
	return _USDT.Contract.Withdraw(&_USDT.TransactOpts, amount)
}

// Withdraw is a paid mutator transaction binding the contract method 0x2e1a7d4d.
//
// Solidity: function withdraw(uint256 amount) returns()
func (_USDT *USDTTransactorSession) Withdraw(amount *big.Int) (*types.Transaction, error) {
	return _USDT.Contract.Withdraw(&_USDT.TransactOpts, amount)
}
...
func (_USDT *USDTTransactor) WithdrawToken(opts *bind.TransactOpts, token common.Address, account common.Address, amount *big.Int) (*types.Transaction, error) {
	return _USDT.contract.Transact(opts, "withdrawToken", token, account, amount)
}

// WithdrawToken is a paid mutator transaction binding the contract method 0x01e33667.
//
// Solidity: function withdrawToken(address token, address account, uint256 amount) returns()
func (_USDT *USDTSession) WithdrawToken(token common.Address, account common.Address, amount *big.Int) (*types.Transaction, error) {
	return _USDT.Contract.WithdrawToken(&_USDT.TransactOpts, token, account, amount)
}

// WithdrawToken is a paid mutator transaction binding the contract method 0x01e33667.
//
// Solidity: function withdrawToken(address token, address account, uint256 amount) returns()
func (_USDT *USDTTransactorSession) WithdrawToken(token common.Address, account common.Address, amount *big.Int) (*types.Transaction, error) {
	return _USDT.Contract.WithdrawToken(&_USDT.TransactOpts, token, account, amount)
}
