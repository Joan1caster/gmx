...
interface BeefyMigratorInterface extends ethers.utils.Interface {
  functions: {
    "admin()": FunctionFragment;
    "afterGovGranted()": FunctionFragment;
    "beefyTimelockCaller()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "beefyTimelockCaller",
    values?: undefined
  ): string;
...
export class BeefyMigrator extends BaseContract {
  ...
  interface: BeefyMigratorInterface;
  ...
  functions: {
    ...
    beefyTimelockCaller(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    beefyTimelockCaller(overrides?: CallOverrides): Promise<BigNumber>;
