...
interface MockOldRewardRouterV2Interface extends ethers.utils.Interface {
  functions: {
...
export class MockOldRewardRouterV2 extends BaseContract {
  ...
  interface: MockOldRewardRouterV2Interface;
