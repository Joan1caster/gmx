...
interface FastPriceFeedInterface extends ethers.utils.Interface {
  functions: {
    ...
    "initialize(uint256,address[],address[],address[],bytes32[])": FunctionFragment;
    ...
    "setPricesWithData(bytes[])": FunctionFragment;
    "setPricesWithDataAndExecute(address,bytes[],uint256,uint256,uint256,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setPricesWithData",
    values: [BytesLike[]]
  ): string;
  encodeFunctionData(
    functionFragment: "setPricesWithDataAndExecute",
    values: [
      string,
      BytesLike[],
      BigNumberish,
