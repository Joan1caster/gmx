...
interface StabilizeMigratorInterface extends ethers.utils.Interface {
  functions: {
    ...
    "stabilizeCaller()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "stabilizeCaller",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class StabilizeMigrator extends BaseContract {
  ...
  interface: StabilizeMigratorInterface;
  ...
  functions: {
    ...
    stabilizeCaller(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    stabilizeCaller(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    stabilizeCaller(overrides?: CallOverrides): Promise<PopulatedTransaction>;
