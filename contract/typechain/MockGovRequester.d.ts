...
interface MockGovRequesterInterface extends ethers.utils.Interface {
  functions: {
...
export class MockGovRequester extends BaseContract {
  ...
  interface: MockGovRequesterInterface;
